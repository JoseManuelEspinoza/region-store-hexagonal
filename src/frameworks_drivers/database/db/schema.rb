...
ActiveRecord::Schema[7.1].define(version: 2024_03_23_182353) do
  ...
  create_table "carritos", force: :cascade do |t|
    ...
    t.index ["user_id", "producto_id"], name: "index_carritos_on_user_id_and_producto_id", unique: true
  ...
  create_table "productos", force: :cascade do |t|
    ...
    t.index ["region_id"], name: "index_productos_on_region_id"
  end
  ...
  add_foreign_key "productos", "regions"
end
